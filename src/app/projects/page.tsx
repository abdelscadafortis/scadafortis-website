...
const projects = [
  ...
  },
  {
    ...
    status: 'Completed',
    type: 'HVDC · TSO',
    desc: 'SCADA and telecom commissioning on a German TSO offshore HVDC connection.',
    scope: ['Protection relay commissioning', 'IEC 61850 GOOSE and MMS verification', 'SCADA / EMS interface testing', 'Telecom infrastructure commissioning'],
